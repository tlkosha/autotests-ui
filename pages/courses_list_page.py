...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_button = page.get_by_test_id('courses-list-toolbar-create-courses-button')
        ...
        self.course_estimated_time_text = page.get_by_test_id('course-estimate-time-info-row-view-text')
